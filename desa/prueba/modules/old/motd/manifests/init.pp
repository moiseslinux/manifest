...
file { '/tmp/banner':
      ...
      backup  => false,
      content => template('/etc/puppetlabs/code/environments/Produccion/modules/motd/templates/banner.epp'),
    }

file { '/tmp/banner_root':
      ensure  => file,
      backup  => false,
      content => template('/etc/puppetlabs/code/environments/Produccion/modules/motd/templates/banner_root.epp'),
    }
